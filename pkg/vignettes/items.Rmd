...
[^3]: The [German Longitudinal Election Study](http://gles.eu) is funded by the German National Science Foundation (DFG)
and carried out outin close cooperation with the [DGfW](http://www.dgfw.info/), German Society for Electoral Studies.
Principal investigators are Hans Rattinger (University of Mannheim, till 2014), Sigrid Roßteutscher (University of Frankfurt), Rüdiger Schmitt-Beck (University of Mannheim), Harald Schoen (Mannheim Centre for European Social Research, since 2015), Bernhard Weßels (Social Science Research Center Berlin), and Christof Wolf (GESIS – Leibniz Institute for the Social Sciences, since 2012). Neither the funding organisation nor the principal investigators bear any responsibility for the example code 
shown here
