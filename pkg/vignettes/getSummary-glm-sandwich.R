getSummary_lm_coeftest <- function(obj,
            alpha=.05,
            ...
            ){
  smry <- summary(obj)
...
getSummary_glm_coeftest <- function(obj,
            alpha=.05,
            ...){
...
getSummary.lm_sandwich <- function(obj,
            alpha=.05,
            ...)
      getSummary_lm_coeftest(obj=obj,alpha=alpha,vcov=sandwich,...)

getSummary.glm_sandwich <- function(obj,
            alpha=.05,
            ...)
      getSummary_glm_coeftest(obj=obj,alpha=alpha,vcov=sandwich,...)
