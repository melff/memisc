# memisc [![Build Status](https://travis-ci.org/melff/memisc.svg?branch=master)](https://travis-ci.org/melff/memisc) [![CRAN](http://www.r-pkg.org/badges/version/memisc)](http://cran.rstudio.com/package=memisc)
